...
DO $$ BEGIN
  ...
  DROP POLICY IF EXISTS "Backoffice users can delete notifications" ON notifications;
  DROP POLICY IF EXISTS "Backoffice users can insert notifications" ON notifications;
  DROP POLICY IF EXISTS "Backoffice users can update notifications" ON notifications;
